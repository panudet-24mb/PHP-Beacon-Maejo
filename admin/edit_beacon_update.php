        ...
        <div id="typography">
          ...
          <div class="form-group">
            <form action="edit_beacon_update_websiteinfo.php" method="post">
              ...
              <input class="btn btn-success" type="submit" value="UPDATE" onclick="confirmalerthead(event);" >
          </div>
          </form>
...
<button class="btn btn-success" type="submit" onclick="confirmalertflex(event);">Update</button>
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header card-header-primary">
        <h4 class="card-title">ตั้งค่า Secret Password </h4>
        <p class="card-category">Secret Password</p>
      </div>
  ...
  <div class="col-sm-6">
  <div class="card" >
    <form action = "edit_beacon_update_secretpass.php" method="post">
  <input class="form-control form-control-lg"  name="secretpass" type="text" value = "<?php echo $show_beacon["beacon_secret_pass"]; ?>">
  <input type="hidden" id="beacon_has_websiteinfo_beacon_id" name="beacon_has_websiteinfo_beacon_id" value=<?php echo $beacon_has_websiteinfo_beacon_id; ?>>

  <button class="btn btn-primary" type="submit" style="float: right;" onclick="confirmalert(event);" >Update</button>
</form>
...
function confirmalert(e) {
	...
	swal({
    title: 'Are you sure?',
    text: "ยืนยันที่จะอัพเดท SecretPassหรือไม่!",
    type: 'warning',
...
function confirmalertflex(e) {
	e.preventDefault();
	var frm = e.target.form;
	swal({
    title: 'Are you sure?',
    text: "ยืนยันที่จะอัพเดท FlexMessageหรือไม่!",
    type: 'warning',
    showCancelButton: true,
    confirmButtonColor: 'btn btn-success',
    cancelButtonColor: '#d33',
...
function confirmalerthead(e) {
	e.preventDefault();
	var frm = e.target.form;
	swal({
    title: 'Are you sure?',
    text: "ยืนยันที่จะอัพเดทเว็บไซต์กับ Beacon หรือไม่!",
    type: 'warning',
    showCancelButton: true,
    confirmButtonColor: 'btn btn-success',
    cancelButtonColor: '#d33',
