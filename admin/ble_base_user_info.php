...
if(isset($_GET["txtKeyword"]))
{
 ...
 $sql = "SELECT * FROM member WHERE member_name LIKE '%".$strKeyword."%' ";
 ...
 $sql .= " ORDER BY member_id ASC LIMIT $row_start ,$row_end ";
 $query = mysqli_query($conn,$sql);
...
?>
  <tr>
    ...
    <td><?php echo $result["member_uid"];?></td>
    <td><?php echo $result["member_name"];?></td>
    <td><?php echo $result["member_type"];?></td>
    <td><?php echo $result["member_date"];?></td>
    <td align="center"> <a href="checkmemberinfo.php?member_id=<?php echo $result["member_id"];?>" class="btn btn-success">Info</a></td>
