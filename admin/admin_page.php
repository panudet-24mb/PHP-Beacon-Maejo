            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">ฐานที่ 1 </p>


                  <h3 class="card-title">จำนวนที่เข้ามาทั้งหมด <?php echo $objResult['number_enter'] ?> / <?php echo $objResult2["number_all"] ?>
                    <small>คน</small>
                  </h3>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">จำนวนที่เข้ามาทั้งหมด</p>
