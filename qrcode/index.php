...
admin base = <?php echo $_SESSION["admin_level"];?><br>
<br>


</body>
<a href="../admin/admin_page.php" class="btn btn-danger float-right">back to dashboard </a>
    <h1>Scan base จุดที่ <?php echo $_SESSION["admin_level"];?> </h1>
