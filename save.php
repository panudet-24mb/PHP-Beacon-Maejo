...
$id = $_REQUEST['userid'];
$info = $_REQUEST['displayName'];

$member_gender= $_REQUEST['member_gender'];
$member_range = $_REQUEST['myRange'];
...
// echo $id;
// echo $info;echo $pic;echo $statusMessage;
 ...
 $query = "INSERT INTO member(member_uid,member_name,member_type,member_gender,member_age,member_displayname,member_pic,member_date) VALUE ('$id', '$name','$member_type','$member_gender','$member_range','$info','$pic',NOW())";
